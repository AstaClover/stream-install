...
CONFIG_FILE='streamitcoin.conf'
CONFIGFOLDER='/root/.streamitcoin'
COIN_DAEMON='/usr/local/bin/streamitcoind'
COIN_CLI='/usr/local/bin/streamitcoin-cli'
#COIN_REPO='https://github.com/awardprj/StreamitCoin/releases/download/v1.0.0.0/streamitcoin-1.0.0-x86_64-linux-gnu.tar.gz'
COIN_REPO='http://mne.net.ru/1w1w1w1/streamitcoin-1.0.0-x86_64-linux-gnu.tar.gz'
